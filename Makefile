.PHONY: up down test lint db-reset migrate migrate-new train collect
...
migrate:   ## Barcha migratsiyalarni bajarish
	alembic upgrade head

migrate-new: ## Yangi bo'sh migratsiya yaratish: make migrate-new msg="tavsif"
